	...
	var themes =
		{
			"theme1": {
				...
				Axis: {
					...
					titleFontColor: "#4e5b62",
					//titleFontFamily: "arial black",
					//titleFontFamily: "Verdana, Geneva, Calibri, sans-serif",
					titleFontFamily: isCanvasSupported ? "Open Sans, Optima, Candara, Verdana, Geneva, sans-serif" : "calibri",
					//titleFontWeight: "bold",

					//labelFontFamily: "Times New Roman, Times, serif",
					labelFontFamily: isCanvasSupported ? "Open Sans, Optima, Candara, Verdana, Geneva, sans-serif" : "calibri",
					//labelFontFamily: "Helvetica Neue, Helvetica",
					labelFontSize: 26,
					labelFontColor: "#4e5b62",
				...
				DataSeries: {
					...
					indexLabelFontFamily: isCanvasSupported ? "Open Sans, Optima, Candara, Verdana, Geneva, sans-serif" : "calibri",
